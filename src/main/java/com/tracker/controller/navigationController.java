...
public class navigationController {
	...
	public String addCategory(@RequestParam("function") String function,@RequestParam("category") String category) {
		DataBaseManagementSystem.addCategory(function,category);
		return "dashboard";
	}
	...
	public String addLimitPage(@ModelAttribute("limit") MonthlyLimitTable limit,HttpSession session) {
		...
		DataBaseManagementSystem.addLimit(limit);
	...
	public String deleteLimitPage(@RequestParam("category") String category ,HttpSession session) {
		DataBaseManagementSystem.deleteLimit(category,(String)session.getAttribute("user"));
		return "redirect:limitpage";
	}
	...
	public String CustomSearchdata(@RequestParam("fromdate") String from ,@RequestParam("todate") String to,HttpSession session,ModelMap model) {
