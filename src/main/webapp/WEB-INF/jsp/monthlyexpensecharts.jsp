					...
					function() {
						...
						$
								.ajax({
									...
									url : '${pageContext.request.contextPath}/monthlyexpensedata',
...
<body>
	...
	<sql:query dataSource="${db}" var="rs">select sum(expense_amount) as total_amount  from expense_table where username="${user}"  and MONTH(expense_date) = MONTH(CURRENT_DATE()); </sql:query>
	<div class="thistext">
		THIS MONTH EXPENSE:
